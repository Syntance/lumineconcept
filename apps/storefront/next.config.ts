    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://connect.facebook.net https://eu.posthog.com https://eu.i.posthog.com https://challenges.cloudflare.com",
              ...
              "connect-src 'self' https://eu.posthog.com https://eu.i.posthog.com https://connect.facebook.net https://api.mailerlite.com https://challenges.cloudflare.com " + MEDUSA_BACKEND_URL + " " + MEILISEARCH_HOST + SENTRY_CSP_HOSTS,
