import { LayoutGrid, Mail, Package, ShoppingBag, Tags, type LucideIcon } from "lucide-react";
...
const ORDER: Array<keyof ModulesToggle> = ["orders", "products", "categories", "emails"];
