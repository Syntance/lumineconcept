    ...
    <div className="sticky top-16 z-30 -mx-4 border-b border-brand-100 bg-white/95 px-4 py-2.5 backdrop-blur-sm lg:hidden">
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-md border border-brand-200 px-3 py-2 text-base font-medium text-brand-800 transition-colors hover:bg-brand-50"
        >
