...
import { ABOUT_ARCH_IMAGE_CLASS } from "@/components/about/about-media";
...
export function AboutArchImage({
  ...
  return (
    <Image
      ...
      sizes="(max-width: 768px) 36vw, (max-width: 1280px) 40vw, 22.68rem"
      quality={92}
      unoptimized={isCmsImageUnoptimized(src)}
      className={cn("block h-auto w-full", ABOUT_ARCH_IMAGE_CLASS, className)}
      draggable={false}
    />
  );
}
