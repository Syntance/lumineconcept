 ...
 * Nie wołaj reset() w onExpire — powoduje pętlę odświeżania.
 */
export const CheckoutTurnstile = memo(
  forwardRef<CheckoutTurnstileHandle, CheckoutTurnstileProps>(
    function CheckoutTurnstile({ siteKey, onSuccess, onError, onExpire }, ref) {
...
CheckoutTurnstile.displayName = "CheckoutTurnstile";
