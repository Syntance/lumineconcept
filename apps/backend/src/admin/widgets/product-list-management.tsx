...
const HIDE_NATIVE_TABLE_CSS = `
  [class*="product-list-table"],
  .shadow-elevation-card-rest:has(table):not(:has([data-lumine-products])) {
...
const ProductListManagement = () => {
  ...
  return (
    <>
      <style>{HIDE_NATIVE_TABLE_CSS}</style>

      <Container className="p-0" data-lumine-products>
        <div className="flex items-center justify-between gap-4 px-6 py-4">
          <div className="flex items-center gap-3">
            <span className="text-lg font-semibold text-ui-fg-base">
              Products
            </span>
          ...
          <div className="flex items-center gap-3">
            <input
              type="text"
              placeholder="Szukaj…"
              className="w-56 rounded-md border border-ui-border-base bg-ui-bg-field px-3 py-1.5 text-sm placeholder:text-ui-fg-muted focus:border-ui-border-interactive focus:outline-none"
              value={search}
